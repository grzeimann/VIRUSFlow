...
ARTIFACT_KINDS: Dict[str, ArtifactKindSpec] = {
    ...
    "master_hg": _spec("master_hg", PhysicalScope.AMPLIFIER, Unit.ELECTRON.value, CoordinateConvention.ORIENTED_AMPLIFIER, ("master_hg",)),
    ...
    "atmospheric_extinction_model": _spec(
        "atmospheric_extinction_model", PhysicalScope.INSTRUMENT_EPOCH,
        "mag / airmass", CoordinateConvention.WAVELENGTH_ANGSTROM,
